...
<head>
    ...
    <script>
        ...
        window.routes = {
            ...
            adminFornecedores: '{{ route("admin.fornecedores.index") }}',
            adminProdutoFornecedores: '{{ route("admin.produtos.fornecedores", ":id") }}',
            adminProdutoFornecedoresSalvar: '{{ route("admin.produtos.fornecedores.salvar", ":id") }}',
