...
<header class="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-[var(--color-lab-border)]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <nav class="hidden md:flex space-x-8 items-center h-full">
                ...
                <a href="{{ route('site.sorteio.index') }}" class="text-sm font-medium transition-colors {{ request()->routeIs('site.sorteio.*') ? 'text-black' : 'text-gray-500 hover:text-black' }}">SORTEIO</a>
                @auth
                    ...
                    <a href="{{ route('site.sorteios.minhas') }}" class="text-sm font-medium transition-colors {{ request()->routeIs('site.sorteios.*') ? 'text-black' : 'text-gray-500 hover:text-black' }}">SORTEIOS</a>
                @endauth
            </nav>
                    ...
                    <div class="user-dropdown relative">
                        ...
                        <div class="user-dropdown-menu absolute right-0 mt-2 w-52 bg-white border border-[var(--color-lab-border)] shadow-lg opacity-0 invisible transition-all duration-200 z-50">
                            ...
                            <div class="py-1">
                                ...
                                <a href="{{ route('site.sorteios.minhas') }}" class="flex items-center gap-2 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 hover:text-black transition-colors">
    ...
    <div id="mobile-menu" class="md:hidden absolute top-full left-0 right-0 bg-white border-b border-[var(--color-lab-border)] shadow-lg opacity-0 invisible transition-all duration-200 z-40">
        <div class="max-w-7xl mx-auto px-4 py-4 space-y-1">
            ...
            <a href="{{ route('site.sorteio.index') }}" class="block px-4 py-3 text-sm font-medium tracking-wider uppercase transition-colors {{ request()->routeIs('site.sorteio.*') ? 'text-black bg-gray-50' : 'text-gray-500 hover:text-black hover:bg-gray-50' }}">
                Sorteio
            </a>
            @auth
                ...
                <a href="{{ route('site.sorteios.minhas') }}" class="block px-4 py-3 text-sm font-medium tracking-wider uppercase transition-colors {{ request()->routeIs('site.sorteios.*') ? 'text-black bg-gray-50' : 'text-gray-500 hover:text-black hover:bg-gray-50' }}">
                    Meus Sorteios
                </a>
                @if(Auth::user()->coupon_portal_enabled && Auth::user()->cupons()->exists())
