                ...
                <div class="grid lg:grid-cols-3 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-black p-6 text-center">
                            ...
                            <a href="https://wa.me/556721800568" target="_blank" class="inline-block bg-white text-black font-mono uppercase text-[10px] tracking-widest px-6 py-3 hover:bg-gray-100 transition-colors">
                                Chat no WhatsApp
                            </a>
                        </div>
