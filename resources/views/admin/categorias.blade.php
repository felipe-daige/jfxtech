    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6">
        ...
        <div class="border border-[var(--color-lab-border)] bg-white p-5">
            ...
            <div class="flex items-center justify-between border-t border-[var(--color-lab-border)] pt-3">
                ...
                <a href="{{ route('admin.produtos') }}?categoria={{ $categoria->id }}" class="font-mono text-[10px] uppercase tracking-widest text-black hover:text-gray-600 font-bold flex items-center space-x-1">
                    <span>Ver</span>
