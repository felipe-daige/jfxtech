...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!window.showNotification) {
        window.showNotification = function(message, type) {
            ...
            notification.className = 'notification fixed top-4 right-4 z-[60] pointer-events-none px-6 py-3 shadow-lg text-white text-sm font-mono font-bold uppercase tracking-wider transition-all duration-300 transform translate-x-full';
